...
let first_lower_dot: Chemistry.Geometry;
let second_upper_dot: Chemistry.Geometry;
let second_lower_dot: Chemistry.Geometry;
let third_upper_dot: Chemistry.Geometry;
let third_lower_dot: Chemistry.Geometry;
...
let first_down_ray: Chemistry.Line;
let second_up_ray: Chemistry.Line;
let second_down_ray: Chemistry.Line;
let third_up_ray: Chemistry.Line;
let third_down_ray: Chemistry.Line;
...
function activity3() {
   ...
   <input disabled type='button' class='btn btn-primary' value="Next" style="position: absolute;top: 40vw; left:43vw; margin-left: 3%; width: 10vw; font-size: 1.2vw;" id='act3_button' onclick='activity4();'>
	...
	first_lower_dot = new Chemistry.Circle(
		new Chemistry.Point(1500, 393),
		7,
		canvas
	);
	...
	second_lower_dot = new Chemistry.Circle(
		new Chemistry.Point(1500, 393),
		5,
		canvas
	);
	third_upper_dot = new Chemistry.Circle(
		new Chemistry.Point(1500, 393),
		3,
		canvas
	);
	third_lower_dot = new Chemistry.Circle(
		new Chemistry.Point(1500, 393),
		3,
		canvas
	);
	...
	first_down_ray = new Chemistry.Line(
		new Chemistry.Point(1080, 395),
		new Chemistry.Point(1500, 395),
		1,
		'red',
	...
	second_down_ray = new Chemistry.Line(
		new Chemistry.Point(1080, 395),
		new Chemistry.Point(1500, 395),
		0.7,
		'red',
	...
	third_up_ray = new Chemistry.Line(
		new Chemistry.Point(1080, 395),
		new Chemistry.Point(1500, 395),
		0.5,
		'red',
	...
	third_down_ray = new Chemistry.Line(
		new Chemistry.Point(1080, 395),
		new Chemistry.Point(1500, 395),
		0.5,
		'red',
