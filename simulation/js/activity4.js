...
function verify_table() {
    verify_count++;
    let val1 = (document.getElementById(`adj-opp-1`));
    let val2 = (document.getElementById(`d-r-1`));
    let val3 = (document.getElementById(`sin-1`));
    let val4 = (document.getElementById(`lambda-inp-1`));
    let val11 = (document.getElementById(`adj-opp-2`));
    let val21 = (document.getElementById(`d-r-2`));
    let val31 = (document.getElementById(`sin-2`));
    let val41 = (document.getElementById(`lambda-inp-2`));
    let val12 = (document.getElementById(`adj-opp-3`));
    let val22 = (document.getElementById(`d-r-3`));
    let val32 = (document.getElementById(`sin-3`));
    let val42 = (document.getElementById(`lambda-inp-3`));
    let res1 = opp_order1 / selected_adj;
    let res2 = (res1 * Math.PI) / 180;
    let res3 = Math.sin(res2);
    let res4 = res3 / selected_N;
    console.log(res1, res2, res3, res4 * (Math.pow(10, 8)));
    if (verify_count <= 4) {
        ...
        if (!verify_values(parseFloat(val4.value) * (Math.pow(10, (-8))), res4)) {
    ...
    if (selected_n > 1) {
        ...
        if (verify_count <= 4) {
            ...
            if (!verify_values(parseFloat(val41.value) * (Math.pow(10, (-8))), res4)) {
                alert(`please check Lambda value`);
                return;
            }
            alert('All Entered Values are correct!!');
    ...
    if (selected_n > 2) {
        ...
        if (verify_count <= 4) {
            ...
            if (!verify_values(parseFloat(val42.value) * (Math.pow(10, (-8))), res4)) {
                alert(`please check Lambda value`);
                return;
            }
            alert('All Entered Values are correct!!');
        ...
        alert('You have failed multiple times, to enter the correct values. The correct values are:');
    }
...
function verify_error() {
    let dd = document.getElementById('error-dd');
    if (dd.value == '0') {
        return;
    }
    if (dd.value == '1') {
...
function cal_less_than_error(num, val1, val2) {
